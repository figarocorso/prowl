...
func RunWatch(dataDir string, interval time.Duration) error {
	return run(dataDir, interval)
}

func run(dataDir string, interval time.Duration) error {
